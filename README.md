...
#ResponseConcepts framework v.3.0
================
...
2- Install React
go in dos shell/terminal to your main folder for this proget e.g responseconcepts
...
- [Updating to New Releases](#updating-to-new-releases)pu
